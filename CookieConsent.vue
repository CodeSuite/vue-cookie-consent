    ...
    <div v-if="showDialog" class="fixed bottom-0 left-0 right-0 inset-x-0 pb-2 z-50">
        <div class="w-full max-w-7xl mx-auto px-6">
            <div class="p-2 rounded-lg bg-black border border-white">
                <div class="grid grid-cols-1 lg:grid-flow-col place-items-center justify-between">
                    ...
                    <div class="mt-2 w-full sm:mt-0 sm:w-auto">
                        <button
                            ...
                            class="w-full mt-5 lg:mt-auto cursor-pointer px-4 py-2 rounded-md text-sm font-medium text-black bg-white">
                            Allow cookies
                        </button>
                    </div>
                </div>
